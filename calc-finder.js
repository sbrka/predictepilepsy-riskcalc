...
(function () {
  ...
  const CALCS = [
    ...
    ["calc-peds-postop-seizure-freedom", "Seizure Freedom after Focal Resection (children)", "Chance of staying seizure-free 1 and 2 years after focal or lobar resection in children, from five features known at the first postoperative review.", "g4", "surg_outcome", { pop: "paed" }],
    ...
    ["calc-acard-se-mortality", "ACARD Score \u2014 30-day Mortality after Status Epilepticus", "Risk of death within 30 days of status epilepticus from 5 routine factors (age, consciousness, aetiology, refractoriness, disability) \u2014 externally validated (Lattanzi 2026).", "g7", "se_prognosis", { pop: "adult" }],
  ...
  const BADGE = {
    ...
    "calc-acard-se-mortality": ["ec", "Editor\u2019s choice for short-term (30-day) mortality after status epilepticus \u2014 the strongest available tool for this question (tier A; derived n=689, externally validated n=569, AUC 0.86/0.85; outperforms STESS/mSTESS/EMSE/SACE). Point table and per-score risks are exact from the paper. (For long-term 2-year mortality, see the ACD score.)"],
};
